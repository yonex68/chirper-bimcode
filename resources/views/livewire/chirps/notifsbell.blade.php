...
new class extends Component {
    ...
    #[On(['chirp-created', 'notif-marked-as-read'])]
    public function getNotifs(): void
    {
        $this->hasUnreadNotifs = auth()->user()->unreadNotifications->isNotEmpty();
    }
}; ?>

<div>
    <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#aaaaaa" height="20px" width="20px" version="1.1" id="Capa_1" viewBox="0 0 611.999 611.999" xml:space="preserve">
            <g>
                <g>
                    <g>
